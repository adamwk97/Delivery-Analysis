...
ggplot(df, aes(df$OrderAmt, df$TipPercentage, color = df$Dog))+geom_jitter()+ xlab("Order Amount")+ylab("Tip Percentage")+labs(color = "Dog Owner")+ggtitle("Percentage of Tip Based on Total Order")
